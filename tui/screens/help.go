...
func helpContent() []string {
        return []string{
                ...
                "  Reference       Browse all 25 VM opcodes,",
                ...
                "  f               Toggle breakpoint at PC",
                "  F               Clear all breakpoints",
                "  g               Go to memory address",
                "  N               Save numbered snapshot",
                "  P               List snapshots",
                "  q / Ctrl+C      Quit",
                "",
                "COMMANDS (in : mode)",
                ...
                "  x               Run selected vector only",
                "  p               Load vectors from path",
                "  q               Back to debugger",
                "",
                ...
                "  0x11 CALL addr16   Push return addr, jump",
                "  0x12 RET           Pop return addr, jump",
                "  0x13 CMP           Compare (sub w/o push)",
                "  0x14 JNZ addr16    Jump if top != 0",
                "  0x15 JC addr16     Jump if carry flag set",
                "  0x16 SHL           Shift left",
                "  0x17 SHR           Shift right (logical)",
                "  0x18 DIV           Divide (halt on /0)",
                "",
                ...
                "  Directives: .db, .dw, .ascii",
                "  .db 0x41, 0x42      ; emit bytes",
                "  .dw 0x1234          ; emit 16-bit word",
                "  .ascii \"hello\\n\"   ; emit string",
