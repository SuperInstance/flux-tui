...
func init() {
        OpcodeTable = [25]OpcodeMeta{
                ...
                CALL:  {Name: "CALL", Description: "Push return address, jump to addr16", Format: "B", StackEffect: "+1"},
                RET:   {Name: "RET", Description: "Pop return address and jump to it", Format: "-", StackEffect: "-1"},
                CMP:   {Name: "CMP", Description: "Pop two, compare b-a, set flags", Format: "-", StackEffect: "-2"},
                JNZ:   {Name: "JNZ", Description: "Jump to address if top of stack is non-zero", Format: "B", StackEffect: "-1"},
